...
//    }
    ...
    public static void main(String[] args) {
        ...
        int[] a = {2,1,1,2,3,1}; //3
        int[] b = {2,-10,1,2,3,1,3}; //-10
        int[] c = {2,-10,1,2,-10,1,-3}; //-3
        int[] d = {2,2,2,2,3,1,3}; //1
        int[] e = {0,0,0,0,0,0,-2}; //-2
        int[] f = {-2,0,0,0,0,0,0}; //-2
        ...
        System.out.println( Arrays.toString(d) + " : " + solution(d));
        System.out.println( Arrays.toString(e) + " : " + solution(e));
        System.out.println( Arrays.toString(f) + " : " + solution(f));
